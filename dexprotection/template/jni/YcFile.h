...
#define MAGIC "YC0000"
#define CLASS_HASH_MAP "java/util/HashMap"
...
typedef struct _SeparatorData {
     ...
     * */
    unsigned int methodIndexForDexFile;
...
public:
     ...
     * @return true：解析成功。false：解析失败。
     */
    bool parse(JNIEnv * env, unsigned char* ycData, size_t dataSize);
    ...
    const SeparatorData* getSeperatorByMethodIndex(JNIEnv * env, int methodIndexForDex);
